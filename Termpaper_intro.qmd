...
```{r}
SDEM_seed <- errorsarlm(mod3, data = kc_house_data_6666, listw = kc_house_data_6666_W, Durbin = TRUE)
```

```{r}
SLX_seed <- lmSLX(mod3, data = kc_house_data_6666, listw = kc_house_data_6666_W, Durbin = TRUE)
```
